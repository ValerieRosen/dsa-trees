...
class BinaryTree {
  ...
  maxSum() {
    ...
    function maxPathSum(node) {
      ...
      const leftSum = maxPathSum(node.left);
      const rightSum = maxPathSUm(node.right);
  ...
  nextLarger(lowerBound) {
    ...
    while (queue.length) {
      ...
      let higherrThanLowerBound = currentVal > lowerBound;
      let shouldReassignClosest = currentVal < closest || closest === null;

      if (higherrThanLowerBound && shouldReassignClosest) {
        closest = currentVal;
      }
